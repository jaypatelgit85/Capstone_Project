...
public class ShowMovieFav extends AppCompatActivity {
    TextView name;
    ImageView poster;
    String movieId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_movie_fav);
        Intent intent = getIntent();
        String movie = intent.getStringExtra("movieName");
        movieId = intent.getStringExtra("id");
        name = findViewById(R.id.movieNameFav);
        poster = findViewById(R.id.moviePosterFav);
        name.setText(movie);
    ...
    public void removeFav(View view) {
        ...
        DocumentReference docRef = db.collection(user.getUid()).document("Fav");
